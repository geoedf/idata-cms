								...
								<?php if (!User::isGuest()) { ?>
									<li class="user-account loggedin<?php if (User::authorise('core.admin')) { echo ' admin'; } ?>">
										...
										<?php if (User::authorise('core.admin')) { ?>
											<span><a class="icon-star user-account-badge tooltips" href="<?php echo Request::root() . 'administrator'; ?>" title="<?php echo Lang::txt('TPL_MYTEMPLATE_ACCOUNT_VIEWING_AS_ADMIN'); ?>"><?php echo Lang::txt('TPL_MYTEMPLATE_ACCOUNT_ADMIN'); ?></a></span>
										<?php } ?>
										<div class="user-account-options">
											...
											<ul>
												<li>
													<a class="icon-th-large" href="<?php echo Route::url(User::link() . '&active=dashboard'); ?>"><span><?php echo Lang::txt('TPL_MYTEMPLATE_ACCOUNT_DASHBOARD'); ?></span></a>
												</li>
												<li>
													<a class="icon-user" href="<?php echo Route::url(User::link() . '&active=profile'); ?>"><span><?php echo Lang::txt('TPL_MYTEMPLATE_ACCOUNT_PROFILE'); ?></span></a>
												</li>
												<li>
													<a class="icon-logout" href="<?php echo Route::url('index.php?option=com_users&view=logout'); ?>"><span><?php echo Lang::txt('TPL_MYTEMPLATE_LOGOUT'); ?></span></a>
												</li>
											</ul>
										</div>
									</li>
